# Generated by Django 3.2.9 on 2021-12-08 04:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Pending'), (1, 'Approved'), (2, 'Denied')], default=1)),
                ('num_of_days', models.FloatField(blank=True, verbose_name='number of days(Auto-calculated)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'First half'), (1, 'Second half'), (2, 'Full'), (3, 'No Leave')], default=2)),
                ('additional_information', models.TextField(blank=True)),
                ('leave', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='leave_days', to='leave.leave')),
            ],
        ),
    ]
